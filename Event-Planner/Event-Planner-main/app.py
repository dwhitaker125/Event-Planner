...
def add_event():
    ...
    if request.method == 'POST':
        ...
        cursor = conn.cursor()
        cursor.execute("INSERT INTO events (event_title, event_date, event_time, event_location, event_creator, max_attendees) VALUES (?, ?, ?, ?, ?, ?)", 
                       (title, date, time, location, event_creator, max_attendees))
        conn.commit()
        conn.close()
